(function () {
    ...
    var subscriptionMixin = {
        ...
        beforeCreate() {
            this._config = Object.assign( _config, AWEMA.utils.object.get(AWEMA_CONFIG, 'subscription', {}) );
        }
    };
    ...
    var __vue_render__ = function() {
      ...
      return _c("div", [
        _c("p", [
          ...
          _c("code", [_vm._v("SUBSCRIPTION_EXAMPLE")]),
          _vm._v(" from "),
          _c("code", [_vm._v("subscription/resources/lang/**/js.php")]),
          _vm._v(": " + _vm._s(_vm.$lang.SUBSCRIPTION_EXAMPLE))
        ]),
        _vm._v(" "),
        _c(
          "button",
    ...
    __vue_render__._withStripped = true;
      ...
      var subscription = normalizeComponent_1(
    ...
    const awemaPlugin = {
        ...
        install(AWEMA) {
            ...
            AWEMA._store.registerModule('subscription', subscriptionModule);
            AWEMA.lang = lang;
        }
    };
